<?php
    ...
    $q="insert into courses (`createdby`,`coursename`,`filetype`,`filepath`,`courseduration`,`createdon`)
    			 values ('".$user['userid']."','".$_GET['course-name']."','".$ext."','".$path."','".($_GET['hour']*60 + $_GET['minute'])."','".$date."')";
    mysqli_query($con,$q);
    echo 'done';
?>